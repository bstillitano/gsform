          ...
          Expanded(
            ...
            child: form = GSForm.multiSection(
              ...
              sections: [
                    ...
                    GSSection(sectionTitle: "Full-Screen Searchable Chip Select",
                    fields: [
                      GSField.chipSelect(
                        tag: "people_multi",
                        title: "Select People (Multi-Select with Search)",
                        weight: 12,
                        multiSelect: true,
                        enableFullScreenSearch: true,
                        fullScreenSearchTitle: "Select People",
                        searchHint: "Search people...",
                        items: [
                          ChipSelectItem(label: "John Smith", data: 1),
                          ChipSelectItem(label: "Jane Doe", data: 2),
                          ChipSelectItem(label: "Bob Wilson", data: 3),
                          ChipSelectItem(label: "Alice Brown", data: 4),
                          ChipSelectItem(label: "Charlie Davis", data: 5),
                          ChipSelectItem(label: "Diana Evans", data: 6),
                          ChipSelectItem(label: "Edward Foster", data: 7),
                          ChipSelectItem(label: "Fiona Green", data: 8),
                          ChipSelectItem(label: "George Harris", data: 9),
                          ChipSelectItem(label: "Helen Irving", data: 10),
                          ChipSelectItem(label: "Ian Jackson", data: 11),
                          ChipSelectItem(label: "Julia King", data: 12),
                          ChipSelectItem(label: "Kevin Lee", data: 13),
                          ChipSelectItem(label: "Laura Martin", data: 14),
                          ChipSelectItem(label: "Michael Nelson", data: 15),
                        ],
                        onChanged: (selected) {
                          debugPrint('Multi-select: ${selected.map((s) => s.label).join(", ")}');
                        },
                      ),
                      GSField.chipSelect(
                        tag: "person_single",
                        title: "Select Person (Single-Select with Search)",
                        weight: 12,
                        multiSelect: false,
                        enableFullScreenSearch: true,
                        fullScreenSearchTitle: "Select a Person",
                        searchHint: "Search...",
                        required: true,
                        ...
                        onChanged: (selected) {
                          debugPrint('Single-select: ${selected.isNotEmpty ? selected.first.label : "none"}');
                        },
                      ),
                    ]),
